...
$(EXTENSIONS_DIR)/micro_ros_src/src:
    ...
    cd src/rcl_logging && git checkout 1b7a4e3 && cd ../..; \
    ...
    for d in src/rosidl/rosidl_typesupport_introspection_cpp \
             src/rcl_logging/rcl_logging_log4cxx \
             src/rcl_logging/rcl_logging_spdlog \
             src/rclc/rclc_examples \
             src/rcl/rcl_yaml_param_parser; do \
        [ -d "$$d" ] && touch "$$d/COLCON_IGNORE" || true; \
    done; \
