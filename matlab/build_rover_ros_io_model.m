...
function addBlocks(modelName)
    ...
    ann = Simulink.Annotation(modelName, ['Run the model, then use the teleop figure keys: i/,/j/l/u/o/m/. and space. ' ...
        'If X/Y or range_min look flat while the robot is still, watch the IsNew and *_Nsec scopes for message activity.']);
